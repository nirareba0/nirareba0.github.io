...
const scenes={conversation:{label:'対話の時間',title:'まずは、話すことから。',file:'conversation-v3.mp4'},notebook:{label:'お店らしさを、かたちに',title:'お店の空気を、そのままサイトに。',file:'notebook-v5.mp4'},cups:{label:'話す',title:'二人分の湯のみ。',file:'cups-v2.mp4'},desk:{label:'かたちにする',title:'机の上の紙。',file:'desk-v4.mp4'},evening:{label:'夕方',title:'夕方の光。',file:'evening-v2.mp4'},room2:{label:'午後の部屋',title:'午後の部屋。',file:'room-v4.mp4'}};
